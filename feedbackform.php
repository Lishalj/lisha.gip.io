 ...
 <header class="text-gray-700 body-font">
        <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
          <a href="index.html" class="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
            <img class="object-cover object-center rounded" alt="project" src=" images/logo.PNG" height="70" width="60"a >
        ...
        <div id="border1"  class="container mx-auto flex px-23 py-3 md:flex-row flex-col items-center border-green-500">
            <div class="lg:flex-grow md:w-full lg:pr-0 md:pr-0 flex flex-col md:items-middle md:text-center mb-5 md:mb-9 items-center text-center">
                     <section class="text-gray-700 body-font relative">
                        ...
                        <h1 style="text-decoration-color: green;" class="sm:text-3xl text-2xl font-medium title-font mb-4 text-green-600"> Feedback Form</h1>
                        <p class="lg:w-2/3 mx-auto leading-relaxed text-base"> Please provide your feedback below:</p>
                      </div>
                      <div class="p-300 x1:w-full md:w-full w-full">
                        <div class="h-full p-8 rounded-lg border-2 border-green-500 flex flex-col relative overflow-hidden">
                          <span class="bg-green-500 text-white px-8 py-1 tracking-widest text-xs absolute right-0 top-0 rounded-b">Feedback Form</span>
                          <div class="container px-10 py-0 mx-auto flex flex-wrap items-center">
         
                            <div class="lg:max-w-lg lg:w-full md:w-1/1 w-1/1">
                            <img alt="namaste" class="w-20 h-50 mb-5 object-cover object-center rounded-full inline-block border-2 border-white bg-white" src="images/nams.png">
                                <h1>Thanks for giving your precious time</h1>
                            </div>
                            </div>
                            <hr>
                        ...
                        <input class="w-full bg-gray-100 rounded border border-gray-400 focus:outline-none focus:border-green-500 text-base px-4 py-2 mb-6"placeholder="Your Name(optional)"  type="text" class="form-control" id="name" name="name" >
                         <div class="p-2 w-full">
                                      
                                    <section class="w-full bg-gray-100 rounded border border-gray-400 focus:outline-none focus:border-green-500 text-base px-4 py-2 mb-6" >
                         
                              <label style="float: center; color: green;" for="feedback">How do you rate your overall experience?</label>
                              <br>      
                           <input type="radio" id="bad" name="exper" value="bad" required>
                          <label for="other">Bad</label> &nbsp;
                          <input type="radio" id="average" name="exper" value="average"required>
                          <label for="female">Average</label>&nbsp;
                         
                          <input type="radio" id="good" name="exper" value="good" required>
                          <label for="good">Good&nbsp;</label>
                        </section>
                                  </div>
                                  <input class="w-full bg-gray-100 rounded border border-gray-400 focus:outline-none focus:border-green-500 text-base px-4 py-2 mb-6" placeholder="Email" type="email" name="email" >
                      
                                  <textarea class="w-full bg-gray-100 rounded border border-gray-400 focus:outline-none h-48 focus:border-green-500 text-base px-4 py-2 mb-6 resize-none block" name="mess" placeholder="Message"></textarea>
                       <input   class="btn btn-primary  inline-flex text-white bg-green-500 border-0 py-2 px-4 focus:outline-none hover:bg-green-600 rounded text-lg" type="submit" name="submit" value="Send"> 
                                    <p class="text-xs text-gray-700 mt-3">Your each and every response is valuable for us</p>
                                    </form>
...
$email = $_POST['email'];
$mess= $_POST['mess'];
$insert_query = "INSERT INTO  feedback (name,exper,email,mess) 
                      VALUES ('$name','$exper','$email','$mess')";
